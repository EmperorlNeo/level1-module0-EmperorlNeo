	...
	private void startQuiz() {
		...
		// 2. Set the size of the window in the initializeGui() method below
			...
			if (guess2.equalsIgnoreCase("Leonardo DiCaprio")) {
				...
				JOptionPane.showMessageDialog(null, "Wrong, the correct answer is Leonardo DiCaprio");
			}
			JOptionPane.showMessageDialog(null, "Your current score: " + score);
			showNextImage();
			window.setSize(110, 129);
			...
			if (guess3.equalsIgnoreCase("Morgan Freeman")) {
				...
				JOptionPane.showMessageDialog(null, "Wrong, the correct answer is Morgan Freeman");
			}
			JOptionPane.showMessageDialog(null, "Your current score: " + score);
			showNextImage();
			window.setSize(110, 129);
			...
			if (guess4.equalsIgnoreCase("Jack Black")) {
				...
				JOptionPane.showMessageDialog(null, "Wrong, the correct answer is Jack Black");
			}
			JOptionPane.showMessageDialog(null, "Your current score: " + score);
